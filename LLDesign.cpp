...
void printGrammarTree(int spaceNum, grammarTreeNode* r) {
	if (r == NULL)return;
	...
	case ExpK:
	{
		...
		case ConstK: {
			...
			case IdV:cout << "IdV" << " "; break;
			case ArrayMembV:cout << "ArrayMembV" << " "; break;
			case FieldMembV:cout << "FieldMembV" << " "; break;
			/*default:
				cout << "error! var type.";
				break;*/
			}
		...
		case ExpIdK: {
			cout << "ExpIdK(Vari)" << " ";
			switch (r->Attr.expAttr.varKind) {
			case IdV:cout << "IdV" << " " << r->name[0] << " "; break;
			case ArrayMembV:cout << "ArrayMembV" << " " << r->name[0] << " "; break;
			case FieldMembV:cout << "FieldMembV" << " " << r->name[0] << " "; break;
			default:
				cout << "error! var type.";
				break;
			}
	...
	/*
	if (r->nodeKind == DecK && r->Attr.expAttr.varKind == IdV) {
		cout << r->typeName << " ";
	}
	for (int i = 0; i < r->nameNum; i++) {
		cout << r->name[r->nameNum] << " ";
	}
	*/
